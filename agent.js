...
const CLIENTS = [
  ...
  }
  {
    ...
    topics: [
      'how many calls did your business miss today',
      'every unanswered call is a customer calling your competitor',
      'stop losing customers to voicemail',
      'what does a missed call cost your business',
      'AI voice agent answers every call 24 7',
      'AI receptionist for small business Texas',
      'automated appointment booking for service businesses',
      'AI phone answering service for contractors',
      'never miss a customer call again',
      'your business answers even when you cant',
      'CRM for service businesses Texas',
      'social media automation for local business',
      'AI tools for small business owners',
      'automate your business with AI',
      'AI receptionist for contractors Texas',
      'AI answering service for HVAC companies',
      'AI phone agent for roofing companies',
      'AI receptionist for dental offices',
      'AI booking agent for salons and spas',
      'AI answering service for law firms Texas',
      'AI receptionist for real estate agents',
      'AI phone agent for restaurants Texas',
      'AI voice agent Houston Texas',
      'AI answering service Dallas Texas',
      'AI receptionist Austin Texas',
      'AI phone agent San Antonio Texas',
      'AI voice agent Fort Worth Texas',
      'AI answering service Arlington Texas',
      'AI receptionist Plano Texas',
      'AI voice agent Frisco Texas',
      'AI answering service McKinney Texas',
      'AI receptionist Corpus Christi Texas',
      'AI voice agent Lubbock Texas',
      'AI answering service El Paso Texas',
      'AI receptionist Garland Texas',
      'AI voice agent Irving Texas',
      'AI voice agent Tyler Texas',
      'AI answering service Longview Texas',
      'AI receptionist Gilmer Texas',
      'AI phone agent Marshall Texas',
      'AI voice agent Big Sandy Texas',
      'AI answering service Gladewater Texas',
      'AI receptionist Henderson Texas',
      'AI voice agent Kilgore Texas',
      'AI answering service Sulphur Springs Texas',
      'AI receptionist Mount Pleasant Texas',
    ],
    postTimes: [
      { hour: 8, minute: 0 },
      { hour: 13, minute: 0 },
